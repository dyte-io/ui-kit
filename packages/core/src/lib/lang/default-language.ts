...
export const defaultLanguage = {
  ...
  'failed.description':
    'We could not connect you back to the meeting room. Please try rejoining the meeting.',
  'disconnected.description':
    'Please join the meeting in order to see and interact with other participants.',
  ...
  'waitlist.no_requests': 'There are no pending Requests.',
  'stage_request.header_title': 'Join Stage Requests',
  'stage_request.no_requests': 'There are no pending Requests.',
  ...
  'stage.join_summary':
    'You are about to join the stage, your video & audio as shown above will be visible to all participants.',
  ...
  'audio_playback.description':
    'In order to play audio properly on your device, click the button below.',
  ...
  'breakout_rooms.status.assign_multiple':
    'Assign multiple participants at once by clicking and selecting them',
  ...
  'breakout_rooms.confirm_modal.start_breakout.content':
    'Once started, all participants will be moved to their assigned rooms.',
  ...
  'breakout_rooms.confirm_modal.close_breakout.content':
    'All breakout rooms will be closed & participants will be moved back to the main room.',
  ...
  'breakout_rooms.leave_confirmation':
  ...
  'network.disconnected':
    'Could not reconnect. Please leave the meeting and try refreshing the window.',
  ...
  'remote_access.indicator':
    'Any plugin or screenshare you switch to will sync the change across the meeting',
  chat: 'Chat',
  'chat.new': 'New',
